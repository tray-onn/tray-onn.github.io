<!DOCTYPE html>
<!-- saved from url=(0050)./page-login.html -->
<html class="no-js" lang=""><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./page-login_files/normalize.css">
    <link rel="stylesheet" href="./page-login_files/bootstrap.min.css">
    <link rel="stylesheet" href="./page-login_files/font-awesome.min.css">
    <link rel="stylesheet" href="./page-login_files/themify-icons.css">
    <link rel="stylesheet" href="./page-login_files/flag-icon.min.css">
    <link rel="stylesheet" href="./page-login_files/cs-skin-elastic.css">
    <!-- <link rel="stylesheet" href="assets/css/bootstrap-select.less"> -->
    <link rel="stylesheet" href="./page-login_files/style.css">
...
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="./index.html">
                        <img class="align-content" src="./page-login_files/logo.webp" alt="">
                    </a>
                </div>
                    ...
                    <form>
                        ...
                        <div class="checkbox">
                            ...
                            <label class="pull-right">
                                <a href="./page-login.html#">Forgotten Password?</a>
                            </label>
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account ? <a href="./page-login.html#"> Sign Up Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript" async="" src="./page-login_files/analytics.js.download"></script><script src="./page-login_files/jquery-2.1.4.min.js.download"></script>
    <script src="./page-login_files/popper.min.js.download"></script>
    <script src="./page-login_files/plugins.js.download"></script>
    <script src="./page-login_files/main.js.download"></script>


<!-- Global site tag (gtag.js) - Google Analytics -->
<script async="" src="./page-login_files/js"></script>
<script>
...
<script defer="" src="./page-login_files/beacon.min.js.download" data-cf-beacon="{&quot;rayId&quot;:&quot;651c4be6aceb5fac&quot;,&quot;token&quot;:&quot;cd0b4b3a733644fc843ef0b185f98241&quot;,&quot;version&quot;:&quot;2021.5.1&quot;,&quot;si&quot;:10}"></script>
