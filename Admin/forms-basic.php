<!DOCTYPE html>
<!-- saved from url=(0051)./forms-basic.html -->
...
<link rel="stylesheet" href="./forms-basic_files/normalize.css">
<link rel="stylesheet" href="./forms-basic_files/bootstrap.min.css">
<link rel="stylesheet" href="./forms-basic_files/font-awesome.min.css">
<link rel="stylesheet" href="./forms-basic_files/themify-icons.css">
<link rel="stylesheet" href="./forms-basic_files/flag-icon.min.css">
<link rel="stylesheet" href="./forms-basic_files/cs-skin-elastic.css">

<link rel="stylesheet" href="./forms-basic_files/style.css">
...
<a class="navbar-brand" href="./"><img src="./forms-basic_files/logo.webp" alt="Logo"></a>
<a class="navbar-brand hidden" href="./"><img src="./forms-basic_files/logo2.webp" alt="Logo"></a>
</div>
...
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Components</a>
...
<li><i class="fa fa-file-word-o"></i><a href="./ui-typgraphy.html">Typography</a></li>
 ...
 <li class="menu-item-has-children dropdown">
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Tables</a>
<ul class="sub-menu children dropdown-menu">
...
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
<ul class="sub-menu children dropdown-menu">
...
<li class="menu-item-has-children dropdown">
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Icons</a>
<ul class="sub-menu children dropdown-menu">
...
<li class="menu-item-has-children dropdown">
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bar-chart"></i>Charts</a>
<ul class="sub-menu children dropdown-menu">
...
<li class="menu-item-has-children dropdown">
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-area-chart"></i>Maps</a>
<ul class="sub-menu children dropdown-menu">
...
<li class="menu-item-has-children dropdown">
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Pages</a>
<ul class="sub-menu children dropdown-menu">
...
<a class="dropdown-item media bg-flat-color-1" href="./forms-basic.html#">
<i class="fa fa-check"></i>
<p>Server #1 overloaded.</p>
</a>
<a class="dropdown-item media bg-flat-color-4" href="./forms-basic.html#">
<i class="fa fa-info"></i>
<p>Server #2 overloaded.</p>
</a>
<a class="dropdown-item media bg-flat-color-5" href="./forms-basic.html#">
...
<a class="dropdown-item media bg-flat-color-1" href="./forms-basic.html#">
<span class="photo media-left"><img alt="avatar" src="./forms-basic_files/1.webp"></span>
...
<a class="dropdown-item media bg-flat-color-4" href="./forms-basic.html#">
<span class="photo media-left"><img alt="avatar" src="./forms-basic_files/2.jpg"></span>
<span class="message media-body">
...
<a class="dropdown-item media bg-flat-color-5" href="./forms-basic.html#">
<span class="photo media-left"><img alt="avatar" src="./forms-basic_files/3.jpg"></span>
<span class="message media-body">
...
<a class="dropdown-item media bg-flat-color-3" href="./forms-basic.html#">
<span class="photo media-left"><img alt="avatar" src="./forms-basic_files/4.webp"></span>
<span class="message media-body">
...
<a href="./forms-basic.html#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<img class="user-avatar rounded-circle" src="./forms-basic_files/admin.jpg" alt="User Avatar">
</a>
<div class="user-menu dropdown-menu">
<a class="nav-link" href="./forms-basic.html#"><i class="fa fa- user"></i>My Profile</a>
<a class="nav-link" href="./forms-basic.html#"><i class="fa fa- user"></i>Notifications <span class="count">13</span></a>
<a class="nav-link" href="./forms-basic.html#"><i class="fa fa -cog"></i>Settings</a>
<a class="nav-link" href="./forms-basic.html#"><i class="fa fa-power -off"></i>Logout</a>
</div>
</div>
<div class="language-select dropdown" id="language-select">
<a class="dropdown-toggle" href="./forms-basic.html#" data-toggle="dropdown" id="language" aria-haspopup="true" aria-expanded="true">
...
<li><a href="./forms-basic.html#">Dashboard</a></li>
 <li><a href="./forms-basic.html#">Forms</a></li>
...
<hr>
<form action="./forms-basic.html" method="post" novalidate="novalidate">
...
<div class="card-body card-block">
<form action="./forms-basic.html" method="post" enctype="multipart/form-data" class="form-horizontal">
<div class="row form-group">
...
<div class="card-body card-block">
<form action="./forms-basic.html" method="post" class="form-inline">
...
<div class="card-body card-block">
<form action="./forms-basic.html" method="post" class="form-horizontal">
<div class="row form-group">
...
<div class="card-body card-block">
<form action="./forms-basic.html" method="post" class="">
...
<script type="text/javascript" async="" src="./forms-basic_files/analytics.js.download"></script><script src="./forms-basic_files/jquery-2.1.4.min.js.download"></script>
<script src="./forms-basic_files/popper.min.js.download"></script>
<script src="./forms-basic_files/plugins.js.download"></script>
<script src="./forms-basic_files/main.js.download"></script>

<script async="" src="./forms-basic_files/js"></script>
<script>
